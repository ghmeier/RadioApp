 ...
 */
#ifndef S3E_EXT_STREAMEREXTENSION_H
#define S3E_EXT_STREAMEREXTENSION_H
...
/**
 * Returns S3E_TRUE if the streamerExtension extension is available.
 */
...
#endif /* !S3E_EXT_STREAMEREXTENSION_H */
